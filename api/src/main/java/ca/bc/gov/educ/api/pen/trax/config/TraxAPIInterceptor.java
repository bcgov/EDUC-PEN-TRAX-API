...
/**
 * The type TRAX api interceptor.
 *
 * @author Om
 */
@Component
public class TraxAPIInterceptor implements HandlerInterceptor {

  /**
   * The constant log.
   */
  private static final Logger log = LoggerFactory.getLogger(TraxAPIInterceptor.class);
